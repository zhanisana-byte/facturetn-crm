  ...
  return (
    <div className="ftn-card">
      ...
      <div className="ftn-grid" style={{ gap: 10 }}>
        <input className="ftn-input" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} />
        <select className="ftn-input" value={role} onChange={(e) => setRole(e.target.value as any)}>
