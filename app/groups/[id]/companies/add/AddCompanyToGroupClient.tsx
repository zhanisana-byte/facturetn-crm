...
export default function AddCompanyToGroupClient({ groupId }: { groupId: string }) {
  ...
  async function onAdd() {
    ...
    // NOTE: adapte selon ton schéma si le nom de table diffère
    const { error } = await supabase
      .from("group_companies")
      .insert({ group_id: groupId, company_id: companyId, link_type: "internal" });
  ...
  return (
    <Card title="Ajouter une société" subtitle="Sélectionner une société existante pour l’ajouter au groupe">
