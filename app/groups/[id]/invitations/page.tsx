...
import GroupInvitationsProClient from "./GroupInvitationsProClient";
...
export default async function GroupInvitationsPage({ params }: Props) {
  ...
  return (
    <div className="p-6 space-y-4">
      <div className="ftn-card-lux p-5">
        <div className="text-xl font-semibold">Inviter lՎquipe</div>
        <div className="text-sm opacity-80">{group.group_name}</div>
      </div>

      <GroupInvitationsProClient groupId={groupId} canInvite={isOwner} />
    </div>
  );
}
