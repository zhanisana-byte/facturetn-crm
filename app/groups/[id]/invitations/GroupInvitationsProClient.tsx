...
export default function GroupInvitationsProClient({
  ...
  const [typeFilter, setTypeFilter] = useState<"all" | "external" | "managed">("all");
  ...
  async function loadAll() {
    ...
    const cc =
      (cRes.data ?? []).map((x: any) => ({
        ...
        link_type: x?.link_type === "managed" ? "managed" : "external",
      })) ?? [];
                  ...
                  <>
                    <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-2">
                      ...
                      <select className="ftn-input" value={typeFilter} onChange={(e) => setTypeFilter(e.target.value as any)}>
                        ...
                        <option value="managed">Gérées</option>
                          ...
                          {pageRows.map((c) => {
                            ...
                            return (
                              <tr key={c.id} className="border-b last:border-0">
                                ...
                                <td className="py-2 px-2">
                                  {c.link_type === "managed" ? pill("Gérée", "ok") : pill("Externe", "warn")}
                                </td>
