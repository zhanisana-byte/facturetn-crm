...
export default function AccessInviteClient({ companies }: { companies: Company[] }) {
  ...
  // ✅ 2 types d’invitation (selon tes règles)
        ...
        <div>
          ...
          {kind === "page_management" ? (
            <select
              className="ftn-input w-full"
              value={pageRole}
              onChange={(e) => setPageRole(e.target.value as PageRole)}
            >
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            ...
            <label className="flex items-center gap-2 text-sm">
              <input
                ...
                onChange={(e) => setCanValidateInvoices(e.target.checked)}
              />
              Valider factures
            </label>
            <label className="flex items-center gap-2 text-sm">
              <input
                ...
                onChange={(e) => setCanSubmitTtn(e.target.checked)}
              />
              Soumettre TTN
            </label>
          </div>
