...
export async function POST(req: Request) {
  ...
  const credRes = await svc
    ...
    .select("signature_provider, signature_config, signer_email, cert_email, updated_at")
  ...
  const authorize_url = digigoAuthorizeUrl({
    env,
    clientId: s(process.env.DIGIGO_CLIENT_ID),
    redirectUri: s(process.env.DIGIGO_REDIRECT_URI),
    credentialId,
