...
export default function TTNSettingsClient({
  ...
  const defaults = useMemo(() => {
    return {
      ...
      ws_matricule: initial?.ws_matricule || "",
  ...
  return (
    <div className="space-y-6">
      <Card
        title="Société"
        subtitle="Les paramètres TTN sont obligatoires par société (chaque société = son TEIF + son certificat + ses accès)."
      >
      ...
      >
        <form action="/companies/ttn/save" method="post" className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          ...
          <div className="lg:col-span-2 flex flex-wrap gap-3 pt-4">
            ...
            <button type="button" className="ftn-btn-ghost" onClick={runTestApi} disabled={!companyId || testingApi}>
