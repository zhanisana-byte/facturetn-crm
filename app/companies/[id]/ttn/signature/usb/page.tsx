...
import UsbSignatureClient from "./ui";
...
export default async function UsbSignaturePage({ params }: Props) {
  ...
  return (
    <div className="p-6">
      <UsbSignatureClient company={company} initial={safeCred} environment={env} />
    </div>
  );
}
