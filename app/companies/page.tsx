...
export default async function CompaniesPage() {
  ...
  // ⚠️ Si ta RLS filtre déjà par owner, cette requête suffit.
  // Sinon adapte selon ton schéma (owner_user_id, created_by, membership, etc.)
      ...
      <div className="max-w-5xl">
        ...
        <div className="ftn-card">
          ...
          <ul className="ftn-list">
            <li>Créer et gérer des factures (PDF / XML)</li>
