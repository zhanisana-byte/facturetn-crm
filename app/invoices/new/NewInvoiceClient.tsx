        ...
        <div className="ftn-card p-5">
          ...
          <div className="mt-3 grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input className="ftn-input" value={customerTaxId} onChange={(e) => setCustomerTaxId(e.target.value)} placeholder={mfPlaceholder} />
            ...
            <tbody>
              {items.map((it, idx) => (
                <tr key={idx}>
                  <td>{idx + 1}</td>
                  <td>
                    <input className="ftn-input" value={it.description} onChange={(e) => updateLine(idx, "description", e.target.value)} placeholder="Description" />
                  </td>
                  <td>
                    <input className="ftn-input" type="number" step="0.001" value={it.quantity} onChange={(e) => updateLine(idx, "quantity", toNum(e.target.value, 0))} />
                  </td>
                  <td>
                    <input className="ftn-input" type="number" step="0.001" value={it.unit_price_ht} onChange={(e) => updateLine(idx, "unit_price_ht", toNum(e.target.value, 0))} />
                  </td>
                  <td>
                    <input className="ftn-input" type="number" step="0.001" value={it.vat_pct} onChange={(e) => updateLine(idx, "vat_pct", toNum(e.target.value, 0))} />
                  </td>
                  <td>
                    <input className="ftn-input" type="number" step="0.001" value={it.discount_pct} onChange={(e) => updateLine(idx, "discount_pct", toNum(e.target.value, 0))} />
                  </td>
      ...
      <div className="fixed right-4 bottom-4 z-[70]">
        <div className="ftn-card px-4 py-3 shadow-lg flex items-center gap-4">
          <div className="leading-tight">
            ...
            <div className="text-base font-semibold">{fmt3(totals.net_to_pay)}</div>
          </div>
