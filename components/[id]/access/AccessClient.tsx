      ...
      <Card title="Accès (Comptable externe & Équipe)">
        ...
        {canInvite ? (
            ...
            <div className="grid md:grid-cols-2 gap-3">
              <label className="flex items-center gap-2 text-sm">
                <input
                  ...
                  onChange={(e) => setPManageCustomers(e.target.checked)}
                />
              ...
              <label className="flex items-center gap-2 text-sm">
                <input
                  ...
                  onChange={(e) => setPCreateInvoices(e.target.checked)}
                />
                Créer factures
              </label>
              ...
              <label className="flex items-center gap-2 text-sm">
                <input
                  ...
                  onChange={(e) => setPValidateInvoices(e.target.checked)}
                />
                Valider factures
              </label>
              ...
              <label className="flex items-center gap-2 text-sm">
                <input
                  type="checkbox"
                  checked={pSubmitTTN}
                  onChange={(e) => setPSubmitTTN(e.target.checked)}
                />
          ...
          <div className="mt-4 text-sm text-slate-600">
            Tu as accès en lecture. Seul <b>owner</b> peut inviter ou modifier permissions.
          </div>
        )}
      </Card>
              ...
              <div key={m.id} className="rounded-xl border border-slate-200 bg-white p-3">
                ...
                {canInvite ? (
                  <div className="mt-3 flex gap-2">
                    <Select
                      value={m.role}
                      onChange={(e) => updateMemberPerm(m.id, { ...m, role: e.target.value })}
                    >
                      <option value="viewer">viewer</option>
                      <option value="staff">staff</option>
                      <option value="accountant">accountant</option>
